#This is R_for_Beginners_Intro.R 

# In this section you will:
# 2.1 Learn basic commands and functions in R
# 2.2 Learn to assign values to variables
# 2.3 Discover types of data

getwd() #Tells you where you are on your computer

setwd("/cloud/project") #Tells your computer where you want to be
...
#R has 1000s of builtin functions you can find out information about how to use them by using 
#the help() function
help(plot)
help(boxplot)
help(barplot)
